...
const Market = () => {
  return (
    ...
    //   </form>
    // </div>
    <div className="flex h-[445px] w-[1478px] items-stretch justify-evenly p-[30px]">
      <div>
        <button className=" rounded border-0 bg-black py-2 px-8 text-white ">
          이전
        </button>
      </div>
      ...
      <div>
        <div className="h-[445px] w-[302px] rounded bg-gray-light ">
          ...
          <div className="p-[25px] text-center text-[24px] text-black">
      ...
      <div>
        <button className=" selection rounded border-0 bg-black py-2 px-8 text-white  ">
          다음
        </button>
      </div>
      ...
      <div>
        <Link
          className="rounded bg-black  py-[20px] px-[20px] text-white"
          to="/nftmint"
        >
          Mint
        </Link>
