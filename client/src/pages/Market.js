...
//   </form>
// </div>
<div className="h-[445px] w-[1478px] p-[30px] flex justify-evenly items-stretch">
 
    <div>
  <button className=" text-white bg-black border-0 py-2 px-8 rounded ">
                      이전
          </button>      
          </div>
 ...
 <div>
<div className="h-[445px] w-[302px] rounded bg-gray-light ">
            <div className="h-[293px] w-[302px] rounded bg-white">
              <img
                className="h-[293px] w-[302px] rounded"
                src={homeImg}
                alt="none"
              ></img>
            </div>
            <div className="p-[25px] text-[24px] text-black text-center">
...
<div className="h-[445px] w-[302px] rounded bg-gray-light ">
  ...
  <button className=" text-white bg-black border-0 py-2 px-8 rounded selection  ">
                      다음
          </button>      
  ...
  <div>
  <button className=" text-white bg-black  py-[20px] px-[20px] rounded   ">
                      Mint
          </button>  
          </div>
